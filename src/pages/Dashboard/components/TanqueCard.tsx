...
const TanqueCard = ({ t, subtitle }: { t: ReabastTanque; subtitle?: string }) => {
  ...
  return (
    <div className="flex h-full flex-col rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md dark:border-gray-700 dark:bg-transparent">
