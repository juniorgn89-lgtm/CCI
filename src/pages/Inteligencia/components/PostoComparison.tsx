    ...
    <div className="space-y-6">
            ...
            >
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">{posto.conversao.toFixed(2)}%</p>
                </div>
              </div>
            </div>
          ))}
              ...
              <tbody>
                {postos.map((p, i) => {
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-right text-gray-600 dark:text-gray-300">{p.conversao.toFixed(2)}%</td>
                  </tr>
                  )
                })}
              </tbody>
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-5">
        {[
          ...
          { label: 'Conversão Média', value: `${networkAvg.conversao.toFixed(2)}%`, icon: Trophy },
        ].map(item => {
