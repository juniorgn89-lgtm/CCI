...
- get_estoque_parado: produtos ENCALHADOS/parados — com saldo e ZERO vendas nos últimos N dias (default 90), ranqueados pelo capital parado (saldo × custo). Use pra "produtos parados/encalhados pra montar promoção", "o que está parado há 90 dias", "capital travado na loja/automotivos". É POR POSTO — informe/assuma um posto (peça se houver vários). Filtra por categoria automotivos/conveniencia.
