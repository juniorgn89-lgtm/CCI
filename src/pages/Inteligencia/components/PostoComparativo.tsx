...
const PostoComparativo = ({ data }: Props) => {
  ...
  if (data.variacaoMes.receita !== 0) {
    insights.push({
      ...
      text: `Receita ${data.variacaoMes.receita >= 0 ? 'cresceu' : 'caiu'} ${Math.abs(data.variacaoMes.receita).toFixed(1)}% vs mês anterior`,
    })
  }
  ...
  if (data.variacaoAno.receita !== 0) {
    insights.push({
      ...
      text: `Receita ${data.variacaoAno.receita >= 0 ? 'subiu' : 'caiu'} ${Math.abs(data.variacaoAno.receita).toFixed(1)}% vs mesmo período do ano anterior`,
    })
  }
  ...
  if (data.variacaoMes.abastecimentos !== 0) {
    insights.push({
      ...
      text: `Volume de abastecimentos ${data.variacaoMes.abastecimentos >= 0 ? 'cresceu' : 'caiu'} ${Math.abs(data.variacaoMes.abastecimentos).toFixed(1)}% vs mês anterior`,
    })
  }
  ...
  if (data.variacaoMes.ticketMedio !== 0) {
    insights.push({
      ...
      text: `Ticket médio ${data.variacaoMes.ticketMedio >= 0 ? 'subiu' : 'caiu'} ${Math.abs(data.variacaoMes.ticketMedio).toFixed(1)}% vs mês anterior`,
    })
  }
