    ...
    <div className="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
      ...
      <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">Abastecimentos recentes</h3>
        ...
        <table className="w-full min-w-[1000px]">
          <thead>
            <tr className="border-b border-gray-200 bg-gray-50 text-xs font-medium uppercase text-gray-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400">
              ...
              <th className="px-4 py-3 text-left">Bomba/Bico</th>
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            {paged.map((row) => (
              <tr key={row.codigo} className="text-sm text-gray-700 transition-colors hover:bg-blue-50/50 dark:text-gray-300 dark:hover:bg-gray-800/50">
