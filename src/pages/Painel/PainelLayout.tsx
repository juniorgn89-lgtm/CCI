...
/**
 * Shell do painel de gestão (master): marca no topo, indicador da rede conectada
 * e a barra horizontal de navegação entre módulos (pills). Standalone — fora do
 * AppLayout do produto (sem sidebar). Cada módulo é uma rota `/painel/*`.
 *
...
const pillInactive = 'border-[#e2e8f0] bg-white text-[#334155] shadow-[0_1px_2px_rgba(15,23,42,0.04)]'
...
const PainelLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7fb] dark:bg-gray-950">
      <div className="mx-auto max-w-5xl px-4 py-5 sm:px-6">
        {/* Topo: marca + rede conectada */}
        ...
        <nav
          aria-label="Módulos"
          className="mt-5 flex gap-[7px] overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
        >
