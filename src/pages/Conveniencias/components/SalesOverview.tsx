...
import { CalendarRange, Eye, ShoppingCart } from 'lucide-react'
...
import MonthRangeSelect from '@/pages/Conveniencias/components/MonthRangeSelect'
...
const SalesOverview = ({ dailyData, groupTable, salesByDay, productsByGroup, catalogProducts }: SalesOverviewProps) => {
  ...
  // Filtro de data local — só "commita" pra store global ao clicar Visualizar.
  // Teste de UX: tira o filtro de data do header global e coloca aqui dentro.
  ...
  return (
    <div className="space-y-4">
      {/* Filtro de data — portado pro sub-bar do header (em linha com o título da página). */}
      <PageHeaderActions>
